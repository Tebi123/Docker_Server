...
resource "aws_security_group" "ec2_security_group" {
  ...
  description = "allow access on ports 80, 9090, 8080 and 22"
...
# print the ssh command to login to the docker server
output "ssh_command" {
  value     = join ("", ["ssh -i project.pem ubuntu@", aws_instance.ec2_instance1.public_dns])
}
